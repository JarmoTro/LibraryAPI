    ...
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
          ...
          <form class="d-flex w-50">
              <div style="width: 95%">
              <input class="form-control me-2" v-model="keywordInput" type="search" placeholder="Search by ISBN, title, genre or author" aria-label="Search" onkeydown="return event.key != 'Enter';">
              </div>
